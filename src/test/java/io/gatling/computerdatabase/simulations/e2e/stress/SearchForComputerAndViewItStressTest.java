package io.gatling.computerdatabase.simulations.e2e.stress;
...
public class SearchForComputerAndViewItStressTest extends Simulation {

    public static class LoadProfile {
        private static final int TOTAL_LOAD = 40;
        private static final int USER_RAMP_UP_PER_INTERVAL = 4;
        private static final Duration TOTAL_RAMP_UP_TIME = Duration.of(60, SECONDS);
        private static final Duration STEADY_STATE_DURATION = Duration.of(60, SECONDS);
    ...
    ScenarioBuilder searchAndOpenScn = scenario("Stress Test: Search for Computer and View It")
